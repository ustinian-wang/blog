import{_ as s,o as i,c as a,a5 as n}from"./chunks/framework.Cjg1mlEg.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"docs/guide/guide-bashrc.md","filePath":"docs/guide/guide-bashrc.md","lastUpdated":1735151742000}'),l={name:"docs/guide/guide-bashrc.md"},p=n(`<div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># git start</span></span>
